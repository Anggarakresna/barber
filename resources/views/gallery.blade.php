...
<div class="row g-3">
    ...
    <div class="col-md-6 col-lg-4 gallery-item">
        <div class="position-relative rounded overflow-hidden" style="background: #111; min-height: 260px; cursor: pointer;"
             ...
             onclick="updateModal('{{ asset('storage/' . $item->image) }}', '{{ $item->title }}')">
...
<script>
    ...
    document.querySelectorAll('.gallery-item').forEach(item => {
        item.addEventListener('mouseenter', function() {
            ...
            overlay.style.cssText = 'background-color: rgba(0, 0, 0, 0.3) !important;';
        ...
        item.addEventListener('mouseleave', function() {
            ...
            overlay.style.cssText = 'background-color: rgba(0, 0, 0, 0) !important;';

    ...
    <div class="col-lg-7">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                <form action="{{ route('admin.gallery.store') }}" method="POST" id="galleryForm">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <small class="text-muted">Pilih gambar, lalu sesuaikan area yang ingin ditampilkan</small>

                        <div id="croppedPreviewWrap" class="mt-3 d-none">
                            <div class="d-flex align-items-center gap-2 mb-2">
                                <span class="badge bg-success"><i class="fas fa-check"></i> Foto siap</span>
